            ...
            <ul class="nav navbar-nav collapse navbar-collapse">
              ...
              <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                  <ul role="menu" class="sub-menu">
                                      <li><a href="{{route('pages.shop')}}">Products</a></li>
                  <li><a href="{{route('pages.product-details')}}">Product Details</a></li> 
              ...
              <li class="dropdown"><a href="#">Blog<i class="fa fa-angle-down"></i></a>
                                  <ul role="menu" class="sub-menu">
                                      <li><a href="{{route('pages.blog')}}">Blog List</a></li>
                  <li><a href="{{route('pages.blog-single')}}">Blog Single</a></li>
                                  </ul>
                              </li> 
              <li><a href="{{route('pages.404')}}">404</a></li>
